          ...
          child: GlassContainer(
            ...
            child: Form(
              ...
              child: Column(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        ...
                        icon: Icon(Icons.close, color: textColor.withAlpha(((0.5)*255).round())),
                      ),
                    ],
                  ),
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      labelStyle: TextStyle(color: textColor.withAlpha(((0.7)*255).round())),
                        ...
                        borderSide: BorderSide(color: textColor.withAlpha(((0.3)*255).round())),
                ...
                // Importance
                Text(i18n.importance, style: TextStyle(color: textColor.withAlpha(((0.7)*255).round()), fontSize: 12)),
                const SizedBox(height: 8),
                SegmentedButton<TodoImportance>(
                  segments: [
                    ButtonSegment(value: TodoImportance.low, label: Text(i18n.low)),
                    ButtonSegment(value: TodoImportance.medium, label: Text(i18n.medium)),
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(i18n.duration, style: TextStyle(fontSize: 12, color: textColor.withAlpha(((0.7)*255).round()))),
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(i18n.startTime, style: TextStyle(fontSize: 12, color: textColor.withAlpha(((0.7)*255).round()))),
                              const SizedBox(height: 4),
                              Text(
